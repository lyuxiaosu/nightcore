...
public:
    ...
    HttpConnection(Engine* engine, int connection_id);
    ~HttpConnection();
    ...
    void OnFuncCallFinished(gateway::FuncCallContext* func_call_context);
...
private:
    ...
    gateway::FuncCallContext func_call_context_;
